...
function loadKeys() {
    try {
        if (fs.existsSync(KEYS_FILE)) {
            ...
            // 🔥 Agar 4 keys nahi hain toh force reset
...
app.get('/', (req, res) => {
    res.json({
        ...
        registered_users: Object.values(keysDB).map(u => u.user_key)
    });
});
...
app.listen(PORT, () => {
    ...
    console.log(`   GET  /admin/check-key?user_key=...`);
